...
def clear_version_caches():
    nameres_version.get_github_commit_hash.cache_clear()
    nameres_version.get_version.cache_clear()
    yield
    nameres_version.get_github_commit_hash.cache_clear()
    nameres_version.get_version.cache_clear()
...
def test_get_version_caches_resolved_version(monkeypatch):
    ...
    monkeypatch.setattr(nameres_version, "read_version_file", read_version_file)
